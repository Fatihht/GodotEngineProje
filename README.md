...
Bu proje, Godot Engine 4.5.1 kullanılarak geliştirilmiş, Google Dinozor oyunu mekaniklerine sahip bir sonsuz koşu (Endless Runner) oyunudur.

Projenin temel amacı; Godot motorunun fizik yeteneklerini ve RayCast2D sensörleri kullanılarak oluşturulan otonom (kendi kendine oynayan) karakter mekaniğini sergilemektir.
...
dec Karar: Eğer engel menzildeyse ve karakter yerdeyse jump() fonksiyonu tetiklenir.
